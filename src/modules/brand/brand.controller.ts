import { Controller, Get, Post, Body, Patch, Param, Delete, UploadedFile, ParseFilePipe, UseInterceptors, UsePipes, ValidationPipe } from '@nestjs/common';
...
import { UpdateBrandDto, BrandParamsDto } from './dto/update-brand.dto';
